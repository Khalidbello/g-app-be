...
const createNewUser = (firstName, lastName, email, password, gender) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        const query = 'INSERT INTO users (first_name, last_name, email, password, gender) VALUES (?, ?, ?, ?, ?)';
        connectdb_1.default.query(query, [firstName, lastName, email, password, gender], (err, result) => {
            if (err) {
