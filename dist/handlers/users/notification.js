...
const checkUnViewedNotiication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // @ts-ignore
        const notificationExists = yield (0, notifications_queries_1.queryUserCountUnViewedNoti)(userId);
...
const getNotifications = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const notificaions = yield (0, notifications_queries_1.queryUserNotifications)(userId, limit, pagin);
...
const setNotToViewed = (req, res) => {
    ...
    try {
        ...
        const updated = (0, notifications_queries_1.userQueryUpdateNoteToViewedById)(userId, notifId);
