...
const getUserProfileData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userData = yield (0, profile_queries_1.queryUserProfile)(userId);
        res.json(userData);
    }
    catch (err) {
...
const handleChangePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updated = yield (0, profile_queries_1.queryUpdatePassword)(userId, newPassword);
        if (!updated)
...
const handleChangeNames = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!userId || !firstName || !lastName)
            return res.status(402).json({ message: 'incomplete data sent to server for processing' });
        const updated = yield (0, profile_queries_1.queryUpdateUserNames)(userId, firstName, lastName);
        if (!updated)
            throw 'something went wrong updatig user Names';
        res.json({ status: updated });
    }
...
const userDpUpload = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // @ts-ignore
        const dpExists = yield queryUserDp(parseInt(userId));
        let saved;
        if (dpExists) {
            saved = (0, profile_queries_1.queryUpdateUserDp)(userId, imageBuffer);
        }
        else {
            saved = (0, profile_queries_1.queryUserSaveDp)(userId, imageBuffer);
        }
        ;
        if (!saved)
...
const getUserDp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // @ts-ignore
        const userDp = yield queryUserDp(userId);
        if (!userDp)
